...
INSERT INTO `cliente` VALUES (1,'Juliana Ferreira','juliana@example.com','minhaSenha123'),(3,'Julia Kimura','juliak@example.com','PaoMel123');
...
CREATE TABLE `pedido` (
  ...
  `STATUS` enum('PENDENTE','FATURADO','CANCELADO') DEFAULT 'PENDENTE',
...
-- Dump completed on 2025-06-01 20:05:24
